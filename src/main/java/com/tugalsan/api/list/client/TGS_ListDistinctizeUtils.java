...
//        });
//    }
    public static <T> List<T> getUnique(List<T> listContainingDuplicates, TGS_Func_OutBool_In2<T, T> equals) {
    ...
    public static <T> void makeUnique(List<T> listContainingDuplicates, TGS_Func_OutBool_In2<T, T> equals) {
