...
public class TGS_ListTable {
    ...
    public TGS_ListTable forEachRowIdx(TGS_Func_OutBool_In1<Integer> optionalRowIdxValidator, TGS_Func_In1<Integer> ri) {
    ...
    public TGS_ListTable forEachRowIdxReversed(TGS_Func_OutBool_In1<Integer> optionalRowIdxValidator, TGS_Func_In1<Integer> ri) {
    ...
    public void deleteRow(TGS_Func_OutBool_In1<Integer> ri, TGS_Func_In1<Integer> runAfterEveryDeleteRowAction) {
    ...
    public void deleteRow(TGS_Func_OutBool_In1<Integer> ri) {
        deleteRow(ri, null);
    }
    ...
    public TGS_ShapeLocation<Integer> find(TGS_Func_OutBool_In1<Object> validator) {
    ...
    public int findAnyColIdx(int atRowIdx, TGS_Func_OutBool_In1<Object> validator) {
        return IntStream.range(0, getColumnSize(atRowIdx))
                .filter(ci -> validator.validate(getValueAsObject(atRowIdx, ci)))
                .findAny().orElse(-1);
    }

    public int findFirstColIdx(int atRowIdx, TGS_Func_OutBool_In1<Object> validator) {
        return IntStream.range(0, getColumnSize(atRowIdx))
                .filter(ci -> validator.validate(getValueAsObject(atRowIdx, ci)))
                .findFirst().orElse(-1);
    }

    public List<Integer> findAllColIdxs(int atRowIdx, TGS_Func_OutBool_In1<Object> validator) {
        return IntStream.range(0, getColumnSize(atRowIdx))
                .filter(ci -> validator.validate(getValueAsObject(atRowIdx, ci)))
                .boxed()
    ...
    public int findAnyRowIdx(int atColIdx, TGS_Func_OutBool_In1<Object> validator) {
        return IntStream.range(0, rows.size())
                .filter(ri -> validator.validate(getValueAsObject(ri, atColIdx)))
                .findAny().orElse(-1);
    }

    public int findFirstRowIdx(int atColIdx, TGS_Func_OutBool_In1<Object> validator) {
        return IntStream.range(0, rows.size())
                .filter(ri -> validator.validate(getValueAsObject(ri, atColIdx)))
                .findFirst().orElse(-1);
    }

    public List<Integer> findAllRowIdxs(int atColIdx, TGS_Func_OutBool_In1<Object> validator) {
        return IntStream.range(0, rows.size())
                .filter(ri -> validator.validate(getValueAsObject(ri, atColIdx)))
                .boxed()
                .collect(Collectors.toCollection(ArrayList::new));
